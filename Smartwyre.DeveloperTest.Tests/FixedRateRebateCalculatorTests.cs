...
public class FixedRateRebateCalculatorTests
{
    ...
    private readonly FixedRateRebateCalculator _sut;
    ...
    public FixedRateRebateCalculatorTests()
    {
        ...
        _sut = new FixedRateRebateCalculator(_mockProductReader.Object,_mockRebateReader.Object, _mockRebateWriter.Object);
    ...
    public void Calculate_Success()
    {
        ...
        _mockRebateWriter.Verify(x=>x.StoreCalculationResult(It.Is<Rebate>(y => y.Percentage==10), 1000),Times.Once);
    ...
    public void Calculate_InvalidRebate_Fail(Rebate rebate)
    {
        ...
        _mockRebateWriter.Verify(x=>x.StoreCalculationResult(rebate, 1000), Times.Never);
        _mockRebateReader.Verify(x=>x.Get(Request.RebateIdentifier),Times.Once);
        _mockProductReader.Verify(x=>x.Get(Request.ProductIdentifier),Times.Once);
    }
    [Fact]
